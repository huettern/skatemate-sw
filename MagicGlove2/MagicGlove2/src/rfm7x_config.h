...
#define RFM7x_CSN_LOW PORTE &= ~(1<<PORTE2)		// VPORT0.OUT &= ~PIN1_bm;
#define RFM7x_CSN_HI  PORTE |= (1<<PORTE2)		// VPORT0.OUT |= PIN1_bm;
#define RFM7x_CE_LOW  PORTE &= ~(1<<PORTE3)

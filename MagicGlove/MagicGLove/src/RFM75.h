...
void Rfm75TxAddress(uint8_t *, uint8_t);
void Rfm75RxAddress0(uint8_t *, uint8_t);
void Rfm75RxAddress1(uint8_t *, uint8_t);
void Rfm75RxAddressN(uint8_t, uint8_t);

void Rfm75Ptx(void);
void Rfm75Prx(void);

void Rfm75Channel(uint8_t);
void Rfm75EnablePipe(uint8_t, uint8_t);
void Rfm75EnableAutoAck(uint8_t, uint8_t);
void Rfm75ReTxTime(uint8_t);
void Rfm75ReTxCount(uint8_t);
void Rfm75PayloadLength(uint8_t, uint8_t);
void Rfm75FlushTxBuffer(void);
uint8_t Rfm75CountArc(void);
uint8_t Rfm75CountLoss(void);
uint8_t Rfm75FifoStatus(void);

//This functions are most likely not to be used in the project and are target for extinction.
void Rfm75EnableCrc(uint8_t);
void Rfm75CrcBytes(uint8_t);
void Rfm75PowerMode(uint8_t);
void Rfm75OutputPower(uint8_t);
void Rfm75AddrBytes(uint8_t count);
void Rfm75AirDataRate(uint8_t);
